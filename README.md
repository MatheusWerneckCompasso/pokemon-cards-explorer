...
> Consiste em uma aplicação que usa a api https://pokemontcg.io/, para obter sobre cartas de pokemons, e contém a listagem das cartas, busca de cartas específicas, e visualização do detalhes das mesmas
